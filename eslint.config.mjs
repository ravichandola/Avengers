...
export default tseslint.config(
  {
    ignores: [
      ...
      'performance-framework/dist/**',
      'performance-framework/dashboard/dist/**',
      'performance-framework/perf-output/**',
      'performance-framework/src/reporting/html-report/report.js',
      'eslint.config.mjs',
      '*.json',
    ],
  },
