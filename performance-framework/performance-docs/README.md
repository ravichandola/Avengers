...
All documentation for this package lives in **`performance-docs/`** (this folder). Source, examples, and CLI live in the parent directory [**`..`**](../) (`performance-framework/` package root).
...
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Isolation, hexagonal layout, adapters, reporting, operations |
